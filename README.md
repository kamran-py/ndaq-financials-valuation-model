...
- `NDAQ_Financials_ValuationAnalysis.pdf` - written valuation memo
- `sample_nasdaq_financials.xlsx` - Excel model
- `screenshots/valuation_tab.png` - valuation tab screenshot
- `screenshots/forecast_drivers.png` - forecast assumptions screenshot
